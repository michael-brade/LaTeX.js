...
scripts:
    ...
    build: "
        ...
        echo -n index latex.ltx symbols generator html-generator | xargs -d' '
    ...
    devbuild: "
        ...
        lsc -c -m embedded -o dist src/plugin-pegjs.ls src/symbols.ls src/latex.ltx.ls src/generator.ls src/html-generator.ls;
